...
ACHIEVER_HANDSHAKE_RETRY_DEBUG_MESSAGE = "|cffffd200Achiever|r debug: no reply yet, resending handshake whisper to %s.";
ACHIEVER_SYNC_REQUESTED_MESSAGE = "|cffffd200Achiever|r: sync requested, waiting for server...";
ACHIEVER_SYNC_COMPLETE_MESSAGE = "|cffffd200Achiever|r: sync complete.";
ACHIEVER_SYNC_NOT_READY_MESSAGE = "|cffffd200Achiever|r: not ready to sync yet, please wait a moment and try again.";
ACHIEVER_SYNC_BUTTON_LABEL = "Sync";
